...
import { CartWithDivider } from '../src/CartWithDivider'

export default {
  title: 'E-Commerce/ShoppingCarts/CartWithDivider',
  component: CartWithDivider,
} as Meta

export const Default: ComponentStoryObj<typeof CartWithDivider> = {
  args: {
    cartItems: [
      {
        id: '1',
